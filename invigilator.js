    ...
    try {
        ...
        if (!error && sessions) {
            ...
            invigilatorCompetitions.forEach(competition => {
                competition.isCompleted = completedCompetitionIds.includes(competition.id);
            });
        }
    } catch (error) {
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="w-10 h-10 ${competition.isCompleted ? 'bg-green-500' : 'bg-blue-500'} rounded-xl flex items-center justify-center text-white">
